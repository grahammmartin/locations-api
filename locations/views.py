...
from .serializers import (
    ...
    DistanceLocationRequestSerializer,
)
...
class LocationViewSet(ListModelMixin, viewsets.GenericViewSet):
    ...
    @action(detail=False, methods=["post"], serializer_class=DistanceLocationRequestSerializer)
    def calculate_distance(self, request):
        serializer = DistanceLocationRequestSerializer(data=request.data)
